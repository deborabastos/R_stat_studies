...
#Para remover notação científica:
options(scipen = 666)

2*pt(q = t, df = gl)


########## COMO FAZER COM COMANDOS DO R ##########
...
#Altere o valor de n de 5 em 5 observe que a medida que os graus de liberdade aumenta a distribuição se aproxima da normal. Como os valores são gerados aleatoriamente poderemos ter curvas diferentes para um mesmo valor de n, mas a medida que n cresce o comportamento simétrico tende a estabilizar.
